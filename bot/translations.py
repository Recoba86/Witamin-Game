...
class Translations:
    ...
    EN = {
        ...
        "rule_hints": "• Bot reacts 👍 if number is higher, 👎 if lower",
        ...
        "help_step4": "4. Bot reacts 👍 (higher) or 👎 (lower) to each guess",
    ...
    FA = {
        ...
        "rule_hints": "• ربات با 👍 می‌گوید عدد بالاتر است، با 👎 می‌گوید پایین‌تر است",
        ...
        "help_step4": "۴. ربات با 👍 (بالاتر) یا 👎 (پایین‌تر) به هر حدس پاسخ می‌دهد",
